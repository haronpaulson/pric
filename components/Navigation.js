...
function Navigation() {
    return (
        <div className="flex justify-between p-4 items-center text-2xl bg-black text-white sticky top-0  rounded-sm">
            ...
            <div className="text-sm space-x-2  flex  md:space-x-8 md:text-lg lg:text-2xl  ">
                <Link href="/Books"><p1 className="flex under  rounded-full "><TbBooks className="mt-1 mr-1"/>Books</p1></Link>
                <Link href="/About"><p2 className="flex under"><BsPersonFill className="mr-1 mt-1"/>About</p2></Link>
            </div>
